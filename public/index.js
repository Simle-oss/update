new window.CozeWebSDK.WebChatClient({
  ...
  */
  auth: {
    type: 'token',
    token: process.env.VUE_APP_INDEX_APIKEY,
  ...
  */
  userInfo: {
    id: 'user',
    url: 'https://i.imgs.ovh/2025/07/17/DAcAM.png',
    nickname: '用户',
  },
  ui: {
    /**
    ...
    */
    footer: {
      isShow: true,
      expressionText: 'Powered by CTRI',
    },
    /**
